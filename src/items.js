...
const items = [
  ...
  {name: 'HC', type: 'dungeon', images: [uncle], smallKeyMax: 1, smallKeyMin: 1},
  {name: 'EP', type: 'dungeon', images: [null, crystal, redCrystal, pendant, greenPendant], smallKeyMax: 0, smallKeyMin: 0, smallKeyGoMode: 0},
  ...
  {name: 'DP', type: 'dungeon', images: [null, crystal, redCrystal, pendant, greenPendant], smallKeyMax: 1, smallKeyMin: 1, smallKeyGoMode: 0},
  {name: 'TH', type: 'dungeon', images: [null, crystal, redCrystal, pendant, greenPendant], smallKeyMax: 1, smallKeyMin: 1, smallKeyGoMode: 0},
  ...
  {name: 'AT', type: 'dungeon', images: [aganim, aganim], smallKeyMax: 2, smallKeyMin: 2, smallKeyGoMode: 2},
  {name: 'PD', type: 'dungeon', images: [null, crystal, redCrystal, pendant, greenPendant], smallKeyMax: 6, smallKeyMin: 4, smallKeyGoMode: 1},
  ...
  {name: 'SP', type: 'dungeon', images: [null, crystal, redCrystal, pendant, greenPendant], smallKeyMax: 1, smallKeyMin: 1, smallKeyGoMode: 1},
  {name: 'SW', type: 'dungeon', images: [null, crystal, redCrystal, pendant, greenPendant], smallKeyMax: 3, smallKeyMin: 0, smallKeyGoMode: 0},
  ...
  {name: 'TT', type: 'dungeon', images: [null, crystal, redCrystal, pendant, greenPendant], smallKeyMax: 1, smallKeyMin: 1, smallKeyGoMode: 0},
  {name: 'IP', type: 'dungeon', images: [null, crystal, redCrystal, pendant, greenPendant], smallKeyMax: 2, smallKeyMin: 0, smallKeyGoMode: 0},
  {name: 'MM', type: 'dungeon', images: [null, crystal, redCrystal, pendant, greenPendant], smallKeyMax: 3, smallKeyMin: 0, smallKeyGoMode: 0},
  {name: 'TR', type: 'dungeon', images: [null, crystal, redCrystal, pendant, greenPendant], smallKeyMax: 4, smallKeyMin: 4, smallKeyGoMode: 0},
  {name: 'GT', type: 'dungeon', images: [aganim, aganim], smallKeyMax: 4, smallKeyMin: 4, smallKeyGoMode: 1},
]

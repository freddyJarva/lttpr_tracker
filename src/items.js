...
const blumerang = ITEM_ASSET_FOLDER + "/boomerang0.png";
const boomerang = ITEM_ASSET_FOLDER + "/boomerang2.png";
const hookshot = ITEM_ASSET_FOLDER + "/hookshot.png";
const bombs = ITEM_ASSET_FOLDER + "/bomb0.png";
const powder = ITEM_ASSET_FOLDER + "/powder.png";
const shroom = ITEM_ASSET_FOLDER + "/mushroom.png";
const greenPendant = ITEM_ASSET_FOLDER + "/dungeon1.png";
const pendant = ITEM_ASSET_FOLDER + "/dungeon2.png";
const crystal = ITEM_ASSET_FOLDER + "/dungeon3.png";
const redCrystal = ITEM_ASSET_FOLDER + "/dungeon4.png";
const aganim = ITEM_ASSET_FOLDER + "/agahnim0.png";
const frod = ITEM_ASSET_FOLDER + "/firerod.png";
const irod = ITEM_ASSET_FOLDER + "/icerod.png";
const bombos = ITEM_ASSET_FOLDER + "/bombos.png";
const ether = ITEM_ASSET_FOLDER + "/ether.png";
const quake = ITEM_ASSET_FOLDER + "/quake.png";
const lantern = ITEM_ASSET_FOLDER + "/lantern.png";
const hammer = ITEM_ASSET_FOLDER + "/hammer.png";
const flute = ITEM_ASSET_FOLDER + "/flute.png";
const shovel = ITEM_ASSET_FOLDER + "/shovel.png";
const net = ITEM_ASSET_FOLDER + "/net.png";
const book = ITEM_ASSET_FOLDER + "/book.png";
const bottle = ITEM_ASSET_FOLDER + "/bottle0.png";
const bottle1 = ITEM_ASSET_FOLDER + "/bottle1.png";
const bottle2 = ITEM_ASSET_FOLDER + "/bottle2.png";
const bottle3 = ITEM_ASSET_FOLDER + "/bottle3.png";
const bottle4 = ITEM_ASSET_FOLDER + "/bottle4.png";
const somaria = ITEM_ASSET_FOLDER + "/somaria.png";
const byrna = ITEM_ASSET_FOLDER + "/byrna.png";
const cape = ITEM_ASSET_FOLDER + "/cape.png";
const mirror = ITEM_ASSET_FOLDER + "/mirror.png";
const boots = ITEM_ASSET_FOLDER + "/boots.png";
const glove1 = ITEM_ASSET_FOLDER + "/glove0.png";
const glove2 = ITEM_ASSET_FOLDER + "/glove2.png";
const flippers = ITEM_ASSET_FOLDER + "/flippers.png";
const orb = ITEM_ASSET_FOLDER + "/moonpearl.png";
const sword1 = ITEM_ASSET_FOLDER + "/sword0.png";
const sword2 = ITEM_ASSET_FOLDER + "/sword2.png";
const sword3 = ITEM_ASSET_FOLDER + "/sword3.png";
const sword4 = ITEM_ASSET_FOLDER + "/sword4.png";
const shield1 = ITEM_ASSET_FOLDER + "/shield0.png";
const shield2 = ITEM_ASSET_FOLDER + "/shield2.png";
const shield3 = ITEM_ASSET_FOLDER + "/shield3.png";
const uncle = ITEM_ASSET_FOLDER + "/uncle.png";
